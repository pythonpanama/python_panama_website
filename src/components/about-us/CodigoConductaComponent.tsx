              ...
              <article className="post post-large blog-single-post border-0 m-0 p-0">
                <div className="post-content ml-0">
                  ...
                  <p className="custom-text-paragraph">
                    ...
                    Para ello, se espera que quien participe en la comunidad
                    muestre respeto y cortesía hacia todos los demás.
                  </p>

                  <p className="custom-text-paragraph">
                    Al participar en la comunidad de Python Panamá, te
                    comprometes a fomentar una experiencia libre de acoso para
                  ...
                  <h4 className="font-weight-bold">Alcance</h4>

                  <p className="custom-text-paragraph">
                    Este código de conducta es aplicable a todas las personas
                    que participen en espacios de la comunidad de Python Panamá,
                    ya sean en línea o presenciales. También se aplica a
                  ...
                  <h4 className="font-weight-bold">Nuestros estándares</h4>

                  <p className="custom-text-paragraph">
                    Ejemplos de comportamiento que contribuyen a crear un
                    ambiente positivo para nuestra comunidad:
                  </p>
                  <ul className="custom-list">
                    <li>
                      Demostrar empatía y amabilidad ante otras personas. No
                      insultes o humilles a otros asistentes. Recuerda que las
                      bromas sexistas, racistas o discriminatorias no son
                      apropiadas. Nunca lo son.
                    </li>
                    <li>
                    ...
                    <li>
                      Aceptar la responsabilidad y disculparse ante quienes se
                      vean afectados por nuestros errores, aprendiendo de la
                      experiencia.
                    </li>
                    <li>
                    ...
                    <li>
                      Usar un lenguaje inclusivo y que dé cabida a una audiencia
                      diversa.
                    </li>
                    <li>
                      Prestar especial atención a las personas que recién llegan
                      a la comunidad.
                    </li>
                  </ul>
                  ...
                  <p className="custom-text-paragraph">
                    ...
                    acoso por fotografías o grabaciones, constante interrupción
                    de charlas u otros eventos, contacto físico inapropiado y
                    atención sexual no deseada.
                  </p>

                  <h4 className="font-weight-bold">Cumplimiento</h4>
                  ...
                  <p className="custom-text-paragraph">
                    ...
                    comentarios, <em>commits</em>, código, ediciones de páginas
                    de wiki, tickets y otras contribuciones que no se alineen
                    con este código de conducta, y comunicará las razones para
                  ...
                  <p className="custom-text-paragraph">
                    ...
                    de otro modo podrán ser denunciados a las personas
                    administradoras de la comunidad responsables del
                    cumplimiento:
                  </p>
                  <ul className="custom-list">
                    <li>
                    ...
                    <li>
                      Si se trata de un espacio en línea, ponte en contacto con
                      las personas moderadoras de ese espacio.
                    </li>
                    <li>
                      En{" "}
                      <a
                      ...
                      , a la persona propietaria del grupo u otras
                      administradoras.
                    </li>
                    <li>
                  ...
                  <p className="custom-text-paragraph">
                    Todas las personas administradoras de la comunidad están
                    obligadas a respetar la privacidad y la seguridad de quienes
                    denuncien incidentes.
                  </p>

                  <p className="custom-text-paragraph font-weight-bold">
                    {" "}
                    Esperamos que los participantes, conferencistas, socios y
                    patrocinadores sigan estas reglas en todos los espacios
                    virtuales y presenciales de los eventos.
                  </p>

                  <p className="custom-text-paragraph">
                    Tenemos participantes encantadores y confiamos en que este
                    código de conducta refleja las opiniones de la mayoría de
                  ...
                  <p className="custom-text-paragraph">
                    Este código de conducta extiende el ya existente con
                    aportaciones de otros códigos:
                  </p>

                  <li>
                    La versión 2.0 en español del{" "}
                    <a
                    ...
                    , versión 2.0{" "}
                    <a
                      href="https://www.contributor-covenant.org/es/version/2/0/code_of_conduct/"
                      target="_blank"
                      rel="nofollow"
                    >
                      HomePage
                  ...
                  <li>
                    ...
                    <a
                      href="https://2020.djangocon.eu/conduct/code_of_conduct/"
                      target="_blank"
                      rel="nofollow"
                    >
                      {" "}
                  ...
                  <li>
                    El código de conducta de{" "}
                    <a
                      href="https://es.python.org/codigo-conducta/"
                      target="_blank"
                      rel="nofollow"
                    >
                      {" "}
